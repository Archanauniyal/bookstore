...
export default function Contactus() {
  return (
    ...
    <div className='contactusmain'>
     ...
     <p>Call Center - 8949270689 - 11 AM to 5 PM (Mon to Sat)<br></br>
Chat - 11 AM to 8 PM (Mon to Sat) What's App Only<br></br>
Email - 11 AM to 8 PM (Mon to Sat)</p>
<h2>Have questions?</h2>
<p>For questions, you can reach out or call our team at 8949270689.
<br></br>
Happy shipping!Team Boookart online book store</p>
      </div>
      <div className='contactform'>
      <h2>Get in Touch</h2>
      <div className='input'>
     <div><input className='text' type='text'placeholder='Mr'/></div>
     <div><input  className='text'type='text'placeholder=' first Name'/></div>
     <div><input  className='text' type='text'placeholder='last Name'/></div>
      </div>
      <div>
      ...
      <div className='postal code'>
        <input  className='text' type='text'placeholder='E Mail Adress'/>
         <input  className='text' type='text' placeholder='Telephone Number'/>
      </div>
